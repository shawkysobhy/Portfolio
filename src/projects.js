...
export const PROJECTS = [
	{
		...
		projectLink: 'https://github.com/wagihmohamed/lecture-dashboard',
		links: [
			{
				title: 'Repo',
				url: 'https://github.com/wagihmohamed/lecture-dashboard',
			},
			{
				title: 'Live',
				url: 'https://lecture-dashboard-ivyyuxfo5-wagihmohamed.vercel.app/',
			},
		],
		projectImage:
